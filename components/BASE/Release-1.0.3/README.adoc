# BaseTypes Release-1.0.3

The https://specifications.openehr.org/releases/BASE/Release-1.0.3[BASE Release-1.0.3] specifications does not contain any type definition that requires to have an XML schema.
